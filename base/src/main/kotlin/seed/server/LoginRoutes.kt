...
fun loginRoutes(
    ...
    "/sbp/auth/login" bind POST to authHandler.login(),
    "/sbp/auth/refresh" bind POST to authHandler.refresh(),
    "/sbp/auth/logout" bind POST to loginRequired(config).then(authHandler.logout())
)
